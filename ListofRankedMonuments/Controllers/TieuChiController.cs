...
namespace QUANLYVANHOA.Controllers
{
    ...
    public class TieuChiController : ControllerBase
    {
        ...
        public TieuChiController(ITieuChiRepository tieuchirepository)
        {
        ...
        public async Task<IActionResult> GetByID(int id)
        {
            ...
            var tieuchiModel = new TieuChiModel
            {
        ...
        [HttpPost("Insert")]
        [Authorize(Policy = "AdminPolicy")]
        public async Task<IActionResult> Insert([FromBody] TieuChiModel tieuchiModel)
        {
        ...
        [HttpPut("Update")]
        [Authorize(Policy = "AdminPolicy")]
        public async Task<IActionResult> Update([FromBody] TieuChiModel tieuchiModel)
        {
